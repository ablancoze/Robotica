...
static const char qt_meta_stringdata_SpecificWorker[] = {
    "SpecificWorker\0\0compute()\0sendJoyStickEvent()\0"
    "value,type,number\0receivedJoyStickEvent(int,int,int)\0"
};
...
void SpecificWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendJoyStickEvent(); break;
        case 2: _t->receivedJoyStickEvent((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    }
}
