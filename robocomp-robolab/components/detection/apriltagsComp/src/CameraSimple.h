...
struct TImage
{
    ...
    std::tuple<const int&, const int&, const int&, const ImgType&> ice_tuple() const
    {
...
public:
    ...
    {
        im = _makePromiseOutgoing<TImage>(true, this, &CameraSimplePrx::_iceI_getImage, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getImageAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<TImage>>().get_future())
    {
        return _makePromiseOutgoing<TImage, P>(false, this, &CameraSimplePrx::_iceI_getImage, context);
    }

    ::std::function<void()>
    getImageAsync(::std::function<void(TImage)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<TImage>(response, ex, sent, this, &RoboCompCameraSimple::CameraSimplePrx::_iceI_getImage, context);
    }

    /// \cond INTERNAL
    void _iceI_getImage(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<TImage>>&, const ::Ice::Context&);
    /// \endcond
...
public:
    ...
    void getImage(::RoboCompCameraSimple::TImage& im, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
    ...
    void end_getImage(::RoboCompCameraSimple::TImage& im, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getImage(::RoboCompCameraSimple::TImage& iceP_im, const ::Ice::AsyncResultPtr&);
    /// \endcond
