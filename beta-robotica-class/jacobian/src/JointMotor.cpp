...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getMotorParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorParams>>& outAsync, const ::std::string& iceP_motor, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getMotorState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorState>>& outAsync, const ::std::string& iceP_motor, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getMotorStateMap(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorStateMap>>& outAsync, const MotorList& iceP_mList, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getAllMotorState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorStateMap>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getAllMotorParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorParamsList>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompJointMotor::JointMotorPrx::_iceI_getBusParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<BusParams>>& outAsync, const ::Ice::Context& context)
{
