...
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompSimpleArm_SimpleArm_ops, iceC_RoboCompSimpleArm_SimpleArm_ops + 8, current.operation);
    if(r.first == r.second)
    {
...
RoboCompSimpleArm::SimpleArm::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompSimpleArm_SimpleArm_all, iceC_RoboCompSimpleArm_SimpleArm_all + 8, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
