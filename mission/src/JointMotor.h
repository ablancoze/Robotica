...
public:
    ...
    {
        return _makePromiseOutgoing<MotorParams>(true, this, &JointMotorPrx::_iceI_getMotorParams, motor, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getMotorParamsAsync(const ::std::string& motor, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<MotorParams>>().get_future())
    {
        return _makePromiseOutgoing<MotorParams, P>(false, this, &JointMotorPrx::_iceI_getMotorParams, motor, context);
    }

    ::std::function<void()>
    getMotorParamsAsync(const ::std::string& motor,
                        ::std::function<void(MotorParams)> response,
                        ::std::function<void(::std::exception_ptr)> ex = nullptr,
                        ::std::function<void(bool)> sent = nullptr,
                        const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<MotorParams>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getMotorParams, motor, context);
    }

    /// \cond INTERNAL
    void _iceI_getMotorParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorParams>>&, const ::std::string&, const ::Ice::Context&);
    /// \endcond

    MotorState getMotorState(const ::std::string& motor, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<MotorState>(true, this, &JointMotorPrx::_iceI_getMotorState, motor, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getMotorStateAsync(const ::std::string& motor, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<MotorState>>().get_future())
    {
        return _makePromiseOutgoing<MotorState, P>(false, this, &JointMotorPrx::_iceI_getMotorState, motor, context);
    }

    ::std::function<void()>
    getMotorStateAsync(const ::std::string& motor,
                       ::std::function<void(MotorState)> response,
                       ::std::function<void(::std::exception_ptr)> ex = nullptr,
                       ::std::function<void(bool)> sent = nullptr,
                       const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<MotorState>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getMotorState, motor, context);
    }

    /// \cond INTERNAL
    void _iceI_getMotorState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorState>>&, const ::std::string&, const ::Ice::Context&);
    /// \endcond

    MotorStateMap getMotorStateMap(const MotorList& mList, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<MotorStateMap>(true, this, &JointMotorPrx::_iceI_getMotorStateMap, mList, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getMotorStateMapAsync(const MotorList& mList, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<MotorStateMap>>().get_future())
    {
        return _makePromiseOutgoing<MotorStateMap, P>(false, this, &JointMotorPrx::_iceI_getMotorStateMap, mList, context);
    }

    ::std::function<void()>
    getMotorStateMapAsync(const MotorList& mList,
                          ::std::function<void(MotorStateMap)> response,
                          ::std::function<void(::std::exception_ptr)> ex = nullptr,
                          ::std::function<void(bool)> sent = nullptr,
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<MotorStateMap>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getMotorStateMap, mList, context);
    }

    /// \cond INTERNAL
    void _iceI_getMotorStateMap(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorStateMap>>&, const MotorList&, const ::Ice::Context&);
    /// \endcond

    void getAllMotorState(MotorStateMap& mstateMap, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        mstateMap = _makePromiseOutgoing<MotorStateMap>(true, this, &JointMotorPrx::_iceI_getAllMotorState, context).get();
    }
    ...
    auto getAllMotorStateAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<MotorStateMap>>().get_future())
    {
        return _makePromiseOutgoing<MotorStateMap, P>(false, this, &JointMotorPrx::_iceI_getAllMotorState, context);
    }

    ::std::function<void()>
    getAllMotorStateAsync(::std::function<void(MotorStateMap)> response,
                          ::std::function<void(::std::exception_ptr)> ex = nullptr,
                          ::std::function<void(bool)> sent = nullptr,
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<MotorStateMap>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getAllMotorState, context);
    }

    /// \cond INTERNAL
    void _iceI_getAllMotorState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorStateMap>>&, const ::Ice::Context&);
    /// \endcond

    MotorParamsList getAllMotorParams(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<MotorParamsList>(true, this, &JointMotorPrx::_iceI_getAllMotorParams, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getAllMotorParamsAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<MotorParamsList>>().get_future())
    {
        return _makePromiseOutgoing<MotorParamsList, P>(false, this, &JointMotorPrx::_iceI_getAllMotorParams, context);
    }

    ::std::function<void()>
    getAllMotorParamsAsync(::std::function<void(MotorParamsList)> response,
                           ::std::function<void(::std::exception_ptr)> ex = nullptr,
                           ::std::function<void(bool)> sent = nullptr,
                           const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<MotorParamsList>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getAllMotorParams, context);
    }

    /// \cond INTERNAL
    void _iceI_getAllMotorParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<MotorParamsList>>&, const ::Ice::Context&);
    /// \endcond

    BusParams getBusParams(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<BusParams>(true, this, &JointMotorPrx::_iceI_getBusParams, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getBusParamsAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<BusParams>>().get_future())
    {
        return _makePromiseOutgoing<BusParams, P>(false, this, &JointMotorPrx::_iceI_getBusParams, context);
    }

    ::std::function<void()>
    getBusParamsAsync(::std::function<void(BusParams)> response,
                      ::std::function<void(::std::exception_ptr)> ex = nullptr,
                      ::std::function<void(bool)> sent = nullptr,
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<BusParams>(response, ex, sent, this, &RoboCompJointMotor::JointMotorPrx::_iceI_getBusParams, context);
    }

    /// \cond INTERNAL
    void _iceI_getBusParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<BusParams>>&, const ::Ice::Context&);
    /// \endcond
