...
/** \mainpage RoboComp::rocochoco
 *
 * \section intro_sec Introduction
 *
 * The rocochoco component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/rocochoco --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class rocochoco : public RoboComp::Application
{
public:
	rocochoco (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::rocochoco::run(int argc, char* argv[])
{
